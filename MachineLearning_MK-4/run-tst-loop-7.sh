...
for momentum in 0.80 0.85 0.90 0.95 0.97; do 
    ...
    python evaluate.py --checkpoint "checkpoints-$hiddim-$layers-$momentum/best.pt" --data raw-trafic-data.json  --output-dir "checkpoints-$hiddim-$layers-$momentum"  >> test-loop-6.log
