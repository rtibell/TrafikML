...
for layers in 20 24 28 32 36; do 
    ...
    python evaluate.py --checkpoint "checkpoints-$hiddim-$layers/best.pt" --data raw-trafic-data.json  --output-dir "checkpoints-$hiddim-$layers"  >> test-loop-6.log
    open checkpoints-$hiddim-$layers/confusion_matrix.png
done
