...
from dataset import SegmentSpeedDataset, TargetTransform, FixedScaler, load_dataframe, split_train_test
from train import parse_conv_channels
...
def main() -> None:
    ...
    model = TabularCNNRegressor(
        conv_channels=parse_conv_channels(train_args["conv_channels"]),
        kernel_size=train_args["kernel_size"],
        dropout=train_args["dropout"],
        status_embed_dim=train_args["status_embed_dim"],
